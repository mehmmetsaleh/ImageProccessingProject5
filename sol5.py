...
def learn_super_resolution_model(super_resolution_num_res_blocks, quick_mode=False):
    ...
    if not quick_mode:
        train_model(model, images_for_super_resolution(), corruption_func, batch_size, steps_per_epoch, num_epochs,
                    1000)
    else:
        train_model(model, images_for_super_resolution(), corruption_func, 10, 3, 2, 30)
...
Answer2 = "still didn't choose"  # @param {type:"string"}
