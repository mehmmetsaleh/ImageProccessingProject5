# -*- coding: utf-8 -*-
"""Copy of Copy of Copy of Copy of IMPR Ex5.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1lUzf0XlgqnOOfb5vjx-_U0tc2pQ-kjXm
...
"""###Version 1.4 - Last Update 17.01.2021
**Changelog:** 
* Changed the names of the plot files from `depth\_plot\_denoise.png` and  `depth\_plot\_deblur.png` to `depth_plot_denoise.png` and  `depth_plot_deblur.png`


**Version 1.3 - 14.01.2021 Changelog:** 
* Change the due date 
...
cs_id = "mohammadsaleh" #@param {type:"string"}
...
def load_dataset(filenames, batch_size, corruption_func, crop_size):
    ...
    while True:
        ...
        for i in range(batch_size):
            ...
            corrupt_im = corruption_func(cropped_im)

            row0_new = np.random.randint(cropped_im.shape[0]-crop_r)
...
def train_model(model, images, corruption_func, batch_size, steps_per_epoch, num_epochs, num_valid_samples):
    ...
    history = model.fit_generator(train_generator,epochs=num_epochs, steps_per_epoch=steps_per_epoch, validation_data=valid_generator, validation_steps=num_valid_samples)
...
def restore_image(corrupted_image, base_model):
    ...
    zero_avg_corrected_img = new_model.predict(zero_avg_corr_image)[0].astype(np.float64)
...
# loss_val3 = model3.history.history['val_loss']
# loss_val4 = model4.history.history['val_loss']
# loss_val5 = model5.history.history['val_loss']
# epoch = range(0,10)
# plt.plot(epoch,loss_val1, 'b', label='1 ResBlocks')
# plt.plot(epoch,loss_val2, 'g', label='2 ResBlocks')
# plt.plot(epoch,loss_val3, 'orange', label='3 ResBlocks')
# plt.plot(epoch,loss_val4, 'r', label='4 ResBlocks')
# plt.plot(epoch,loss_val5, 'purple', label='5 ResBlocks')
# plt.title('Denoising')
# plt.xlabel('Epoch')
...
# model4 = learn_deblurring_model(4,quick_mode=False)
# model5 = learn_deblurring_model(5,quick_mode=False)
...
**Note:** In your submission, the names of the plots should be `depth_plot_denoise.png` and  `depth_plot_deblur.png` and they should be located in the same directory as the rest of your files.
"""
